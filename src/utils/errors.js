export const errors = {
  ...
  failedToCreatePetWithImage: {
    status: 'error',
    error: 'Failed to create pet with image',
    code: 500
  },
  ...
  emailAlreadyExists: { status: 'error', error: 'Email already exists', code: 409 },
  invalidPassword: { status: 'error', error: 'Incorrect password', code: 401 },
  ...
  failedToGenerateMockData: { status: 'error', error: 'Failed to generate mock data', code: 500 }
};
